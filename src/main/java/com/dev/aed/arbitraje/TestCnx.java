 ...
 * @author Cesar
 */
public class TestCnx extends javax.swing.JFrame {

    /**
     * Creates new form TestCnx
     */
    public TestCnx() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestCnx.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
